...
if __name__ == "__main__":
    ...
    glass2 = Glass(100, 500)  # TODO инициализировать ещё один стакан
    ...
    # glass1.capacity_volume += 50 TODO доливаем воды в первый стакан
    print(glass1.capacity_volume, glass1.occupied_volume)
    print(glass2.capacity_volume, glass2.occupied_volume)

    print(glass1 is glass2) # проверяем, что это два разных объекта TODO сравнить id объектов
